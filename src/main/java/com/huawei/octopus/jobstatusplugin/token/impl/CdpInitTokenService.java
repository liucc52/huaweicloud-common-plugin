...
/**
 * CloudDragonTokenService
 */
public class CdpInitTokenService implements TokenService{
	
	private static final Logger LOGGER = Logger.getLogger(CdpInitTokenService.class.getName());
	...
	public String getToken(JobStatusEntity job, WorkflowRun run) {
		try {
			...
			LOGGER.log(Level.SEVERE, 
					String.format("%s getToken error, jobId: %s", Constants.LOG_PREFIX, job.getJobId()), t);
			return null;
		}
	}
